# Form implementation generated from reading ui file 'mzmlplotter_v2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scannumberSpinbox.setProperty("value", 1)
        ...
        self.highySpinbox.setProperty("value", 100000)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 350, 361, 121))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.gridLayout = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.plotButton = QtWidgets.QPushButton(parent=self.gridLayoutWidget_2)
        ...
        self.annothresh_Spinbox = QtWidgets.QDoubleSpinBox(parent=self.gridLayoutWidget_2)
        self.annothresh_Spinbox.setMaximum(100.0)
        self.annothresh_Spinbox.setProperty("value", 5.0)
        self.annothresh_Spinbox.setObjectName("annothresh_Spinbox")
        self.gridLayout.addWidget(self.annothresh_Spinbox, 2, 1, 1, 2)
        self.anno_Checkbox = QtWidgets.QCheckBox(parent=self.gridLayoutWidget_2)
        self.anno_Checkbox.setChecked(False)
        self.anno_Checkbox.setTristate(False)
        self.anno_Checkbox.setObjectName("anno_Checkbox")
        self.gridLayout.addWidget(self.anno_Checkbox, 1, 1, 1, 2)
        self.maxanno_Spinbox = QtWidgets.QSpinBox(parent=self.gridLayoutWidget_2)
        self.maxanno_Spinbox.setMaximum(999999999)
        self.maxanno_Spinbox.setProperty("value", 25)
        self.maxanno_Spinbox.setObjectName("maxanno_Spinbox")
        self.gridLayout.addWidget(self.maxanno_Spinbox, 3, 1, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "mzml Plotter"))
        self.label.setText(_translate("MainWindow", "Mode:"))
        self.modeBox.setItemText(0, _translate("MainWindow", "Single Scan"))
        self.modeBox.setItemText(1, _translate("MainWindow", "Combine Scans (MS1)"))
        self.modeBox.setItemText(2, _translate("MainWindow", "Combine Scans (MS2)"))
        self.modeBox.setItemText(3, _translate("MainWindow", "Plot TIC"))
        self.modeBox.setItemText(4, _translate("MainWindow", "Plot EIC"))
        ...
        self.label_12.setText(_translate("MainWindow", "Annotate Peaks?"))
        self.label_14.setText(_translate("MainWindow", "Max Annotations:"))
        self.label_13.setText(_translate("MainWindow", "Annotation Threshold:"))
        self.label_11.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; text-decoration: underline;\">Annotation Settings</span></p></body></html>"))
        self.anno_Checkbox.setText(_translate("MainWindow", "Annotate"))
